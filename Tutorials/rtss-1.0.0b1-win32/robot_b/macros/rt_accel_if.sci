...
function [x, y, typ] = rt_accel_if(job, arg1, arg2)
// File name:       rt_accel_if.sci
//
// Function:        rt_accel_if
//
// Description:     handle the user interface of the Scicos block named "rt_accel_if"
//
// Annotations:     none
//
// References:      none
...
// Date:            April 2007
//
// $LastChangedDate: 2009-07-21 18:48:47 +0200(mar, 21 lug 2009) $
    ...
    select job,
        ...
        case "set" then
            ...
            while %T do,
                ...
                if ok then
                    ...
                    graphics.gr_i(1) = "xstringb(orig(1), orig(2), [""RTSS""; ""Accel""; """ + robot.name + """], sz(1), sz(2), ""fill"");";
                    x.graphics = graphics;
                    x.model = model;
                    break
                end
        ...
        case "define" then
            model = scicos_model();
            model.sim = list("rtss_scs_accel_cf4", 4);
            model.in = [-1; -1; -1];
            model.in2 = [1; 1; 1];
            model.intyp = [1; 1; 1];
            model.out = -1;
            ...
            model.dep_ut = [%T %F];
            exprs = "rt_robot()";
            gr_i = ["xstringb(orig(1), orig(2), [""RTSS""; ""Accel""; ""noname""], sz(1), sz(2), ""fill"");"];
