...
function [x, y, typ] = rt_tr2rpy_if(job, arg1, arg2)
// File name:       rt_tr2rpy_if.sci
//
// Function:        rt_tr2rpy_if
//
// Description:     handle the user interface of the Scicos block named "rt_tr2rpy_if"
//
...
// Date:            April 2007
//
// $LastChangedDate: 2009-08-06 12:31:34 +0200(gio, 06 ago 2009) $
    ...
    select job,
        ...
        case "define" then
            model = scicos_model();
            model.sim = list("rtss_scs_tr2rpy_cf4", 4);
            model.in = 4;
            model.in2 = 4;
            model.intyp = 1;
            model.out = [1; 1; 1];
            ...
            model.blocktype = "d";
            model.dep_ut = [%T %F];
            gr_i = ["xstringb(orig(1), orig(2), [""RTSS"";"" "";""Tr2RPY""], sz(1), sz(2), ""fill"");"];
