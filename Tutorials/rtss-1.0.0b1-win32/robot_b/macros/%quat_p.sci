...
function %quat_p(q)
// File name:       %quat_p.sci
//
// Functions:       %quat_p, disp
//
// Description:     displays the quaternion as one-line summary of its coefficients
//
...
//                  in Scilab.
//
// References:      Robotics Toolbox for MATLAB(R), robot7.1/@quaternion/display.m
//
