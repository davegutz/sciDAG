...
function [x, y, typ] = rt_jacobn_if(job, arg1, arg2)
// File name:       rt_jacobn_if.sci
//
// Function:        rt_jacobn_if
//
// Description:     handle the user interface of the Scicos block named "rt_jacobn_if"
//
...
// Date:            April 2007
//
// $LastChangedDate: 2009-08-01 15:13:05 +0200(sab, 01 ago 2009) $
    ...
    select job,
        ...
        case "set" then
            ...
            while %T do,
                ...
                if ok then
                    ...
                    graphics.gr_i(1) = "xstringb(orig(1), orig(2), [""RTSS""; ""  n""; ""   J""; """ + robot.name + """], sz(1), sz(2), ""fill"");";
                    x.graphics = graphics;
                    x.model = model;
                    break
                end
        ...
        case "define" then
            model = scicos_model();
            model.sim = list("rtss_scs_jacobn_cf4", 4);
            model.in = -1;
            model.in2 = 1;
            model.intyp = 1;
            model.out = 6;
            ...
            model.dep_ut = [%T %F];
            exprs = "rt_robot()";
            gr_i = ["xstringb(orig(1), orig(2), [""RTSS""; ""  n""; ""   J""; ""noname""], sz(1), sz(2), ""fill"");"];
