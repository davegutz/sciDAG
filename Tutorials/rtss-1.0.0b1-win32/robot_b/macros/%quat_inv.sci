...
// File name:       %quat_inv.sci
//
// Functions:       %quat_inv, inv
//
// Description:     invert a quaternion
//
// Annotations:     this code is a Scilab port of corresponding function in the
//                  Robotics Toolbox for MATLAB(R) written by Peter I. Corke.
//
// References:      Robotics Toolbox for MATLAB(R), robot7.1/@quaternion/inv.m
//
