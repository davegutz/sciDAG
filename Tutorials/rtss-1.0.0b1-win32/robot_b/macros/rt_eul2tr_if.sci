...
function [x, y, typ] = rt_eul2tr_if(job, arg1, arg2)
// File name:       rt_eul2tr_if.sci
//
// Function:        rt_eul2tr_if
//
// Description:     handle the user interface of the Scicos block named "rt_eul2tr_if"
//
...
// Date:            April 2007
//
// $LastChangedDate: 2009-08-04 16:48:06 +0200(mar, 04 ago 2009) $
    ...
    select job,
        ...
        case "define" then
            model = scicos_model();
            model.sim = list("rtss_scs_eul2tr_cf4", 4);
            model.in = [1; 1; 1];
            model.in2 = [1; 1; 1];
            model.intyp = [1; 1; 1];
            model.out = 4;
            ...
            model.blocktype = "d";
            model.dep_ut = [%T %F];
            gr_i = ["xstringb(orig(1), orig(2), [""RTSS""; " "; ""Eul2Tr""], sz(1), sz(2), ""fill"");"];
