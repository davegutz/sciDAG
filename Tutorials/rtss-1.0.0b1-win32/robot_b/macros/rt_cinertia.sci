...
function [Mx] = rt_cinertia(robot, q)
// File name:       rt_cinertia.sci
//
// Functions:       rt_cinertia
//
// Description:     compute the Cartesian (operational space) manipulator inertia matrix
//
// Annotations:     this code is a Scilab port of corresponding function in the
//                  Robotics Toolbox for MATLAB(R) written by Peter I. Corke.
//
// References:      Robotics Toolbox for MATLAB(R), robot7.1/cinertia.m
//
