...
pathPC = get_absolute_file_path("rt_pumacheck.tst");

mprintf("***************************************************************\n");
mprintf("************************ Puma 560 *****************************\n");
mprintf("***************************************************************\n");

exec(pathPC + "../models/rt_puma560.sce");
exec(pathPC + "../models/rt_puma560akb.sce");

rdh = p560;
rmdh = p560m;

exec(pathPC + "rt_check1.sce");

clear pathPC rdh rmdh p560 p560m
