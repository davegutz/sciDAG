...
// Open xcos file
current_directory = get_absolute_file_path('L4_demo00.sce');
importXcosDiagram(current_directory + "L4_sim_ol_first.zcos");
...
while w < 10
    w = 1.1 * w;
    scs_m.props.context = ["w = "+string(w)]
