...
LIBRARY = xcos_toolbox_skeleton_c
# ------------------------------------------------------
# list of files
FILES_SRC = sci_tbx_sum.c xcos_toolbox_skeleton_c.c
# ------------------------------------------------------
# list of objects file
OBJS = sci_tbx_sum.obj xcos_toolbox_skeleton_c.obj
OBJS_WITH_PATH = Release/sci_tbx_sum.obj Release/xcos_toolbox_skeleton_c.obj
# ------------------------------------------------------
# added libraries
FORTRAN_RUNTIME_LIBRARIES = 
OTHERLIBS = ../../src/c/libxcos_tbx_skel.lib
# ------------------------------------------------------
!include $(SCIDIR)\modules\dynamic_link\src\scripts\Makefile.incl.mak
# ------------------------------------------------------
#CC = 
# ------------------------------------------------------
CFLAGS = $(CC_OPTIONS) -D__SCILAB_TOOLBOX__ -DFORDLL  -I"C:\Users\Dave\Documents\GitHub\sciDAG\SkeletonTest\contrib_from_scilab552\xcos_toolbox_skeleton\src\c"  
# ------------------------------------------------------
