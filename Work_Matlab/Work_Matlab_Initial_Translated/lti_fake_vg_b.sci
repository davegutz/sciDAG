...
// !! L.58: Unknown function m_valve_a not converted, original calling sequence used.
fake_ehsv = m_valve_a(0,dpav1,wfl);
tee_pr = vol_1(vol_rcham,%beta,sg);
// !! L.60: Unknown function dor_aptow not converted, original calling sequence used.
fake_act = dor_aptow(wfl,dpav2,0,%cd,sg);
// !! L.61: Matlab function summer not yet converted, original calling sequence used.
tee_sum_pr = summer(1,1,0,0);
// !! L.62: Matlab function summer not yet converted, original calling sequence used.
...
// !! L.78: Matlab toolbox(es) function connect not converted, original calling sequence used
